...
import com.googlecode.streamflyer.support.range.MatchResultShifted;
import com.googlecode.streamflyer.support.range.RangeFilterHandler;
 ...
 * if the character buffer window of the use {@link RegexModifier} is smaller than the entire text between two tokens.
 * <p>
